...
func (m *CreateReviewRequest) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetComment()); l < 0 || l > 200 {
		err := CreateReviewRequestValidationError{
			field:  "Comment",
...
var _CreateReviewRequest_ServiceScore_InLookup = map[int64]struct{}{
	0: {},
	1: {},
	2: {},
	3: {},
...
var _CreateReviewRequest_ExpressScore_InLookup = map[int64]struct{}{
	0: {},
	1: {},
	2: {},
	3: {},
...
var _GetReviewReply_ServiceScore_InLookup = map[int64]struct{}{
	0: {},
	1: {},
	2: {},
	3: {},
...
var _GetReviewReply_ExpressScore_InLookup = map[int64]struct{}{
	0: {},
	1: {},
	2: {},
	3: {},
...
func (m *ReplyReviewRequest) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetReplyContent()); l < 1 || l > 200 {
		err := ReplyReviewRequestValidationError{
			field:  "ReplyContent",
